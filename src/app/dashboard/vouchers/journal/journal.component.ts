...
import { Company, Ledgers, User, Voucher } from '../../model';
...
export class JournalComponent {
	...
	public constructor(private titleService: Title, public snackbar: MdSnackBar, private voucherService: VoucherService) {
